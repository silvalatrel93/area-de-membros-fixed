                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2 text-[#00ff00]">
                      ...
                      {status === "completed" && (
                        <>
                          <div className="relative w-6 h-6 rounded-full bg-green-500 flex items-center justify-center shadow-lg">
                            <div className="w-3 h-3 border-2 border-white rounded-sm bg-transparent flex items-center justify-center">
