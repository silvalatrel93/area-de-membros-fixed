          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-8">
                  ...
                  <a href="#" className="netflix-text-secondary hover:text-netflix-red transition-colors duration-200 px-3 py-2 text-sm font-medium">
                    <Bookmark className="inline mr-1" size={16} /> Meus Cursos
                  </a>
                  <a href="#" className="netflix-text-secondary hover:text-netflix-red transition-colors duration-200 px-3 py-2 text-sm font-medium">
              ...
              <div className="flex items-center space-x-4">
                <button className="netflix-text-secondary hover:text-netflix-text transition-colors duration-200">
                  <Search size={20} />
                </button>
                <button className="netflix-text-secondary hover:text-netflix-text transition-colors duration-200">
                  <Bell size={20} />
            ...
            <div className="relative max-w-7xl mx-auto">
              <div className="text-center lg:text-left lg:flex lg:items-center lg:justify-between">
                <div className="lg:flex-1">
                  <h2 className="text-3xl lg:text-4xl font-bold text-netflix-text mb-4">
                    Bem-vindo de volta! 👋
                  </h2>
                  <p className="text-lg netflix-text-secondary mb-6 max-w-2xl">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    <Card className="bg-netflix-red/10 border-netflix-red/20">
                      <CardContent className="p-4 text-center">
                        <div className="text-2xl font-bold text-netflix-red">{completedLessons}</div>
                        <div className="text-sm netflix-text-secondary">Aulas Concluídas</div>
                      </CardContent>
                    </Card>
                    <Card className="bg-blue-500/10 border-blue-500/20">
                      <CardContent className="p-4 text-center">
                        <div className="text-2xl font-bold text-blue-400">{modulesList.length}</div>
                        <div className="text-sm netflix-text-secondary">Módulos Ativos</div>
                      </CardContent>
                    </Card>
                    <Card className="bg-green-500/10 border-green-500/20">
                      <CardContent className="p-4 text-center">
                        <div className="text-2xl font-bold text-green-400">{overallProgress}%</div>
                        <div className="text-sm netflix-text-secondary">Progresso Total</div>
                      </CardContent>
                    </Card>
                  </div>
                </div>
